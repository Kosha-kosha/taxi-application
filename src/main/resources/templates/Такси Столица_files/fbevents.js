            ...
            return function (g, i, j, k) {
                ...
                (function () {
                    ...
                    var k = f.getFbeventsModules("SignalsFBEventsParallelFireConfigTypedef"),
                        ...
                        t = f.getFbeventsModules("SignalsFBEventsLogging"), u = t.logError, v = "global", w = {
                            automaticMatching: q,
                            openbridge: g,
                            batching: p,
                            inferredEvents: r,
                    ...
                    t = function () {
                        ...
                        h(b, [{
                            ...
                            key: "getPCMInstagramTriggerAttributionConfig", value: function (a) {
            ...
            return function (g, i, j, k) {
                ...
                (function () {
                    ...
                    var p = f.getFbeventsModules("SignalsFBEventsOptIn"),
                        ...
                        s = f.getFbeventsModules("SignalsFBEventsURLUtil"), t = s.getURLParameter;
                    s = f.getFbeventsModules("SignalsPixelCookieUtils");
                    var u = s.CLICK_ID_PARAMETER, v = s.readPackedCookie, w = s.CLICKTHROUGH_COOKIE_NAME;
                    s = f.getFbeventsModules("SignalsFBEventsExperimentNames");
                    var x = s.USE_FBC_AS_CACHE_KEY_EXPERIMENT, y = f.getFbeventsModules("SignalsFBEventsQE"),
                        z = f.getFbeventsModules("SignalsParamList"),
                        A = f.getFbeventsModules("signalsFBEventsSendEvent"), B = q.each, C = q.keys, D = q.map,
                        E = q.some, F = d.logError, G = d.logUserError, H = {
                            AutomaticMatching: !0,
                        ...
                        h(d, [{
                            ...
                            key: "loadConfig", value: function (a) {
                                ...
                                if (!this.fbq.pendingConfigs || E(this.fbq.pendingConfigs, function (b) {
                                    ...
                                    if (r() === !1) d = ""; else if (g !== g.parent && c != null && c !== "") {
                                        c = new URL(c);
                                        d = c.hostname
                                    } else if (b != null || b !== "") {
                                        c = new URL(b);
            ...
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsBaseEvent"),
                        ...
                        c = f.getFbeventsModules("SignalsFBEventsTyped"), d = c.Typed, e = c.coerce;
        ...
        f.ensureModuleRegistered("signalsFBEventsGetIsIosInAppBrowser", function () {
            return function (f, g, h, i) {
                ...
                (function () {
                    ...
                    function a() {
                        var a = f.navigator, b = a.userAgent.indexOf("AppleWebKit"), c = a.userAgent.indexOf("FBIOS"),
        ...
        f.ensureModuleRegistered("SignalsFBEventsLogging", function () {
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    var x = "Meta Pixel Error", y = function () {
        ...
        f.ensureModuleRegistered("SignalsFBEventsPIIAutomatchedEvent", function () {
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsBaseEvent"),
                        b = f.getFbeventsModules("SignalsFBEventsPixelTypedef"),
                        c = f.getFbeventsModules("SignalsFBEventsTyped"), d = c.coerce;
        ...
        f.ensureModuleRegistered("signalsFBEventsSendEvent", function () {
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    var u = a.BATCHING_EXPERIMENT, v = a.SEND_BEACON_STRING_EXPERIMENT, w = a.SEND_XHR_EXPERIMENT,
                        x = g.top !== g, y = "SubscribedButtonClick";
            ...
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    c = d.objectWithFields({
                        customData: d.allowNull(d.object()), customParams: function (a) {
                            return a instanceof b ? a : void 0
                        }, eventName: d.string(), id: d.string(), piiTranslator: function (a) {
                            return typeof a === "function" ? a : void 0
                        }, documentLink: d.allowNull(d.string()), referrerLink: d.allowNull(d.string())
                    });
                    a = new a(d.tuple([c]));
                    k.exports = a
                })();
        ...
        f.ensureModuleRegistered("SignalsPixelCookieUtils", function () {
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    c = "_fbc";
                    var e = "fbc", i = "_fbp", j = "fbp", l = "fbclid";
            ...
            return function (a, b, c, d) {
                ...
                (function () {
                    ...
                    var k = f.getFbeventsModules("SignalsFBEventsNetworkConfig"),
                        l = f.getFbeventsModules("SignalsFBEventsQE"), m = f.getFbeventsModules("SignalsParamList"),
                        ...
                        B = f.getFbeventsModules("SignalsFBEventsTyped"), aa = B.coerce, ba = B.Typed, C = o.each;
                    B = o.FBSet;
                    var D = o.isEmptyObject, E = o.isPlainObject, F = o.isNumber, G = o.keys;
                    o = A.execEnd;
                    var H = A.fired, I = A.getCustomParameters, ca = A.iwlBootstrap, J = A.piiInvalidated,
                        da = A.setIWLExtractors, K = A.validateCustomParameters, L = A.validateUrlParameters,
                        ea = p.logError, M = p.logUserError, N = t.global, O = -1,
                        fa = "b68919aff001d8366249403a2544fba2d833084f1ad22839b6310aadacb6a138",
                        ga = Array.prototype.slice, P = Object.prototype.hasOwnProperty, Q = c.href, R = !1, ha = !1,
                        S = [], T = {}, ia;
                    b.referrer;
                    var U = {PageView: new B(), PixelInitialized: new B()}, V = new r(f, T), W = new y(V, N),
                        ja = new B(["eid"]);
                    ...
                    function X() {
                        try {
                            ...
                            var b = x(a), c = [].concat(i(b.args)), d = b.isLegacySyntax, e = c.shift();
                            switch (e) {
                                case"addPixelId":
                                    R = !0;
                                    Y.apply(this, c);
                                ...
                                case"send":
                                    ...
                                    break;
                                case"on":
                                    var j = h(c), k = j[0], l = j.slice(1), m = A[k];
                                    m && m.triggerWeakly(l);
                                    break;
                                case"loadPlugin":
                                    W.loadPlugin(c[0]);
                    ...
                    function la(a) {
                        ...
                        switch (a) {
                            ...
                            case"releaseSegment":
                                ...
                                break;
                            case"autoConfig":
                                var j = c[0], m = c[1], n = j === !0 || j === "true" ? "optIn" : "optOut";
                                if (typeof m !== "string") {
                                    M({
                            ...
                            case"firstPartyCookies":
                                var o = c[0], p = c[1], r = o === !0 || o === "true" ? "optIn" : "optOut";
                            ...
                            case"pcmInstagramTriggerAttribution":
                                var C = c[0];
                                V.pluginConfig.set(C, "pcmInstagramTriggerAttribution", {pcmInstagramTriggerAttributionURL: k.INSTAGRAM_TRIGGER_ATTRIBUTION});
                                break;
                    ...
                    function Z(a, b, c) {
                        for (var d = 0, e = S.length; d < e; d++) {
                            ...
                            sa({customData: b, eventData: c, eventName: a, pixel: f});
                            Object.prototype.hasOwnProperty.call(U, a) && U[a].add(f.id)
                        }
                    }

                    function pa(a, b) {
                        sa({customData: b, eventName: a, pixel: null})
                    }

                    function qa(a, b, c) {
                        S.forEach(function (c) {
                            return sa({customData: b, eventName: a, pixel: c})
                        })
                    }
                    ...
                    function ra(a, b, c, d) {
                        ...
                        try {
                            var g = a && a.userData || {}, h = a && a.userDataFormFields || {}, i = {}, k = {},
                                l = void 0;
                    ...
                    (R && ha || a.fbq !== a._fbq) && M({type: "CONFLICTING_VERSIONS"});
                    ...
                    function ua() {
                        ...
                        var b = w(function () {
                            ...
                            Q = c.href;
                            if (Q === ia) return;
                            var a = new ka({allowDuplicatePageViews: !0});
                    ...
                    function xa(a) {
                        a.instance = V, a.callMethod = X, a._initHandlers = [], a._initsDone = {}, a.send = qa, a.getEventCustomParameters = ra, a.addInitHandler = va, a.getState = wa, a.init = Y, a.set = la, a.loadPlugin = function (a) {
...
fbq.registerPlugin("global_config", {
    __fbEventsPlugin: 1, plugin: function (fbq, instance, config) {
        ...
        fbq.set("experiments", [{
            ...
            "passRate": 0
        }, {"allocation": 0.5, "code": "p", "name": "always_normalize_ph", "passRate": 0.5}]);
